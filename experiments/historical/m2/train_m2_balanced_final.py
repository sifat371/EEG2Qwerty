...
from liteqwerty_eeg.model_m2 import (
    LiteQwertyBalancedModule,
)
...
def main() -> None:
    ...
    print("Building official EEG loaders...")
    ...
    model = LiteQwertyBalancedModule(
